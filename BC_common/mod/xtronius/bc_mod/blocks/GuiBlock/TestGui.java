...
public class TestGui extends BlockContainer
{
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
    	...
    	FMLNetworkHandler.openGui(player, bc_mod.instance, MiscIDs.guiIdTestGui, world, x, y, z);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, GuiBlocks.TestGui.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, GuiBlocks.TestGuiIdle.blockID);
        }
