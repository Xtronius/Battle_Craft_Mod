...
public class BlockSifterStructuring extends BlockGlass{
...
public BlockSifterStructuring(int id)
{
...
{
         for (int i = 0; i < 47; i++) textures[i] = iconRegistry.registerIcon("bc_mod:ctm/woodGlass_" + (i+1));
}
