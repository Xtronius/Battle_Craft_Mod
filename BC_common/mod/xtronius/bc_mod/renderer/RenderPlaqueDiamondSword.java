...
public class RenderPlaqueDiamondSword extends TileEntitySpecialRenderer{
	
	
	    
	    
	    
	private ModelPlaqueDiamondSword model;
	...
	public RenderPlaqueDiamondSword(){
		this.model = new ModelPlaqueDiamondSword();
	}
