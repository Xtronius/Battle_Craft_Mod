...
class GuiXPBlockButton extends GuiButton
{
    ...
    protected GuiXPBlockButton(int par1, int par2, int par3, ResourceLocation par4ResourceLocation, int par5, int par6)
    {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3)
    {
        if (this.drawButton)
        {
            par1Minecraft.getTextureManager().bindTexture(GuiXPBlock.getXPBlockGuiTextures());
            ...
            if (!GuiXPBlock.getXPBlockGuiTextures().equals(this.buttonTexture))
            {
